...
import { antLayoutSider, antLayoutSiderMobile } from "./sider-styles";
...
export const CustomSider: typeof Sider = ({ render }) => {
    ...
    const renderTreeView = (tree: ITreeMenu[], selectedKey: string) => {
        return tree.map((item: ITreeMenu) => {
            ...
            const isMiddleChild = meta?.isMiddleChild;
            const route =
                typeof list === "string"
                    ? list
            ...
            if (children.length > 0) {
                return (
                    <SubMenu
                        ...
                        title={label}
                        // style={{ color: "#6039F5", fontWeight: "normal" }}
                        style={(meta?.parent) ? (meta?.isMiddleChild ? { color: "#FD7326", fontWeight: "600" } : { color: "#000000", fontWeight: "400" }) : {
                            color: "#6039F5", fontWeight: "600"
                        }
                        }
                    >
    ...
    return (
        ...
        >
            ...
            >
                <Title collapsed={collapsed}></Title>
