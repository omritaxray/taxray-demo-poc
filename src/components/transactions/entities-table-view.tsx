...
import { CheckCircleTwoTone, ClockCircleTwoTone, MinusCircleTwoTone, PhoneOutlined } from "@ant-design/icons";
...
export const EntitiesTableView: React.FC<Props> = ({
    tableProps,
    filters,
    sorters,
}) => {
        ...
        <List>
            ...
            >
                ...
                <Table.Column
                    ...
                    render={(_, record: ITransactionVendor) => {
                        if (record.w8 === "") {
                            ...
                            return (
                                <Tag icon={<CheckCircleTwoTone twoToneColor="#69b1ff" />} color="white" bordered={false}>
                                    <Button><Text style={statusTextStyle} >Valid</Text></Button>
                                </Tag>
                            );
                        }
                    }}
                ...
                {/* <Table.Column
                    ...
                    render={(_, record: ITransactionVendor) => {
                        if (record.form1042s === "" || !record.form1042s) {
                            return (
                                <Tag icon={<MinusCircleTwoTone twoToneColor="#FD5526" />} color="red" bordered={false}>
                                    <Text style={statusTextStyle} >Missing</Text>
                                </Tag>
                            ...
                            return (
                                <Tag icon={<CheckCircleTwoTone twoToneColor="#69b1ff" />} color="white" bordered={false}>
                                    <Text style={statusTextStyle} >Filed</Text>
                                </Tag>
                            );
                        }
                    }}
