...
import DashboardBackground from 'components/dashboard/DashboardBackground.png'
...
const WHTDashboardHeader: React.FC = () => {
    return (
        <div style={{ width: "100%", height: "100%", marginLeft: "45px", zIndex: 0 }}>
                    ...
                    <ConfigProvider theme={robotoWhiteConfig}>
                        <Space size={1} direction='vertical' style={{ marginTop: "16px", zIndex: 1, position: "absolute" }}>
                            <Text style={{ fontSize: "32px", fontWeight: "600" }}>
                                Dashboard - Withholding Tax - Non-US Vendors
                            </Text>
            ...
            <div style={{ width: "90%", height: "100%", marginLeft: "3.5%" }}>
                <div style={{ width: "110%", marginTop: "-8%", display: "flex" }}>
                    <KPIsCard isLoading={false} totalCount={"$25,000,000"} trend={""} cardTitle='Gross-Up Costs' cardSubtitle='2023' />
                    <KPIsCard isLoading={false} totalCount={"$45,000,000"} trend="+55.55%" cardTitle='Gross-Up Costs' cardSubtitle='2024' />
                    <KPIsCard isLoading={false} totalCount={"$85,000,000"} trend={"+88.89%"} cardTitle='Gross-Up Costs' cardSubtitle='2025 (projection)' />
                </div>
            </div>
...
export default WHTDashboardHeader