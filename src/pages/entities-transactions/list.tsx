...
import { EntitiesTableView } from 'components/transactions';

type Props = React.PropsWithChildren;
type View = "card" | "table";

const EntitiesTransactionsList: React.FC<Props> = ({ children }) => {
    ...
    return (
        <div className="page-container">
            <h1 style={{ marginLeft: "0.75%" }}>All Entities Foreign Vendors - Withholding Tax</h1>
            <List
                breadcrumb={false}
                headerButtons={() => {
                    return (
...
export default EntitiesTransactionsList