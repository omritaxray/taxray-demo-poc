...
const PRIMARY_PDF_URL = "Figma Software Services Agreement (1).pdf";
...
export const ContractAnalysis = ()  => {
  ...
  const [isHiglightsVisible, setIsHighlightsVisible] = useState(false);
  ...
  const pdfLoader = (): any =>{
    // @ts-ignore
    return (<div><PdfLoader document={url}>
      {(pdfDocument) => (
        <PdfHighlighter
        ...
        >
          {(isHiglightsVisible && <HighlightContainer
